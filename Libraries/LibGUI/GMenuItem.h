...
public:
    ...
    GMenu* submenu() {
        return m_submenu.ptr();
    }
    const GMenu* submenu() const {
        return m_submenu.ptr();
    }
    ...
    void set_menu_id(Badge<GMenu>, unsigned menu_id) {
        m_menu_id = menu_id;
    }
    void set_identifier(Badge<GMenu>, unsigned identifier) {
